...
echo "</br>";
?>
<form action="index.php?option=com_crocodilecontent&view=listpics" method="post" id="adminForm" name="adminForm">
	<div class="row-fluid">
		<div class="span6">
		...
		<tbody>
			<?php if (!empty($this->items)) : ?>
				<?php foreach ($this->items as $i => $row) :
					$link = JRoute::_('index.php?option=com_crocodilecontent&task=listpic.edit&id=' . $row->id);
				?>
					<tr>
